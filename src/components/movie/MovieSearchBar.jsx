    ...
    <div className="relative w-full">
      <div className="relative">
        ...
        <input
          ...
          className="w-full lg:w-80 p-3 pl-10 pr-10 bg-slate-900/70 rounded-md border border-slate-700 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none transition"
        />
        {query && (
