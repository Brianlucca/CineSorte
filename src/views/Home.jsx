...
import FilterSidebar from '../components/filtersRoulette/FilterSidebar'
import MovieDetails from '../components/movie/MovieDetails'
import FilterRoulette from '../components/filtersRoulette/FilterRoulette';
    ...
    <div className="bg-slate-900 min-h-screen text-slate-300 font-sans">
      <div className="relative md:flex">
        ...
        <main className="flex-grow p-4 sm:p-8 md:p-12">
          ...
          <div className="pb-24">
            {mode === 'filters' ? (
              <FilterRoulette genres={genres[mediaType]} onShowDetails={handleShowDetails} mediaType={mediaType} filters={filters} />
            ) : (
              currentUser ? <MyList onShowDetails={handleShowDetails} /> : <Auth />
            )}
          </div>
          <Footer />
        </main>
